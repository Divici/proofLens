...
- Phase 4 (BOOTSTRAP) — in-progress

## Remaining (slice plan)

| # | Slice | Status | Effort |
|---|---|---|---|
| 0001 | Scaffold + dev loop | Pending | 3-4h |
| 0002 | Single-label happy path (LLM only) | Pending | 4-5h |
...
- Test count: 0 (scaffold has not run yet)
